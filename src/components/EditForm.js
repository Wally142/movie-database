...
//             <input value={props.movieTitle}  title={props.movieTitle} type="text" className="form-control" placeholder="Title" />
//             <br />
...
//             <br />
//             <button onClick={() => props.onClick()} className="btn btn-danger">Update Movie</button>
//         </div>
//     </div>
